...
//}else if(@$_GET['m'] == "manual"){           // ⬅️ หน้าใหม่
    //include 'page/backend/page_shop_manual.php';
...
}else if(!preg_match('/^[a-zA-Z0-9\_]*$/', @$_GET['m'])){
...
<div class="col-md-3 col-sm-12">
  <div class="card card-hover shadow-lg px-4 py-3 mb-3" style="background-color:#e6eeff;">
    ...
    <!--<a href="manage/manual" class="btn btn-info mb-1"><i class="fa-solid fa-gamepad"></i> สินค้าแบบแมนนวล</a> <!-- ⬅️ ปุ่มใหม่ -->

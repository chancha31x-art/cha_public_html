...
<div class="col-md-12 col-sm-12 mt-2">
    <div class="card mb-3">
        <div class="card-header"><i class='bx bx-table' ></i> History Buy - ประวัติการซื้อ แอพพรีเมี่ยม</div>
        <div class="card-body">

            <div class="table-responsive">
                <table id="tbl_users1" cellspacing="1" class="table table-striped table-bordered display text-black">
                    <thead>
                        <tr>
                            <th>#Order</th>
                            <th>ชื่อ</th>

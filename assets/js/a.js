...
function error(title, desc, reload) {
  if (reload == "true") {
    Swal.fire({
      ...
      html: '<span style="color:gray">' + desc + "</span>",
      confirmButtonText:
        '<span style="color:black;"><i class="fa fa-times"></i> ปิด</span>',
    ...
    Swal.fire({
      ...
      html: '<span style="color:gray">' + desc + "</span>",
      confirmButtonText:
        '<span style="color:#fff;"><i class="fa fa-times"></i> ปิด</span>',
...
function login() {
  $("#return").html(
    "<script>warning('<i class=\"fa fa-spinner fa-spin fa-fw\"></i>', 'กรุณารอสักครู่...');</script>"
  );
  $.post(
    "system/master.php?login",
    {
